...
export const aliasHandler = async (req: Request, res: Response) => {
    try {
...
export const topicHandler = async (req: Request, res: Response) => {
    try {
...
export const overallAnalyticsHandler = async (req: Request, res: Response) => {
    try {
